...
import {MatButtonModule, MatCheckboxModule, MatCardModule, MatPaginatorModule, MatFormFieldModule} from '@angular/material';
...
@NgModule({
  ...
  imports: [
    ...
    FlexLayoutModule,
    MatButtonModule, MatCheckboxModule, MatCardModule, MatPaginatorModule, MatFormFieldModule
  ],
  providers: [
